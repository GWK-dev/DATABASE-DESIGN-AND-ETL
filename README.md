...
*Click on any asset link above to access the project documentation, visual layouts, data workbook, or executable scripts directly.*
...
* **Multi-Sheet Reporting**: Extracted raw operational sheets from [`company_data.xlsx`](./etl/company_data.xlsx) and appended engineered output sheets (`Salaries`, `Project_Employees`, `Project_Hours`, `Project_Spend`) without disrupting base raw tables.
